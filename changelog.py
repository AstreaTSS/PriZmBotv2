...
v14 = "```\nv1.2.6\nMoving back to Windows, to avoid any future problems. Just remind me to look at the computer once every 8-12 hours.\n!omeprac and !alpprac are now merged into one, called !prac30. A prompt has been introduced to distingush the changes.\n!omepracstart and !alppracstart is now merged into !pracstart. Again, a new prompt.\n!omecan and !alpcan are, you guessed it, merged into one, !canprac. AGAIN, a new prompt. Also removed the \"Practice is canceled\" message because there were too many varibles at play when I thought about it.\nAdjusted channels for PriZm's reorganization of channels.\n"